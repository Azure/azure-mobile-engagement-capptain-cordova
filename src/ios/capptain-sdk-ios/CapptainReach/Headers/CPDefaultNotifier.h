...
/**
 *
 * This is the default notifier used by <CPReachModule>.
 *
 ...
 * edit the provided _`CPNotificationView.xib`_ and change the `AutoSizing` property of the main view so it can be kept
 ...
 *    @interface MyNotifier : CPDefaultNotifier
 *    @end
 *
 ...
 *    @end
 */
@interface CPDefaultNotifier : NSObject<CPNotifier>
{
  @private
  UIImage* _notificationIcon;
  CPInteractiveContent* _content;
  UIView* _containerView;
}

/**
 * Create a default notifier with a given notification icon.
 * The default notification view CPNotificationView will be used to display notifications.
