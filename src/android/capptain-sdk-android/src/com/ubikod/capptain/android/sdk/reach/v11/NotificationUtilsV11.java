...
package com.ubikod.capptain.android.sdk.reach.v11;
...
public final class NotificationUtilsV11
{
   ...
   */
  public static void downloadBigPicture(Context context, CapptainReachInteractiveContent content)
  {
    ...
    File dir = context.getExternalFilesDir("capptain");
    ...
    Intent intent = new Intent(CapptainReachAgent.INTENT_ACTION_DOWNLOAD_TIMEOUT);
    intent.putExtra(CapptainReachAgent.INTENT_EXTRA_CONTENT_ID, contentId);
